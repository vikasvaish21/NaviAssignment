...
extension  UIColor{
    ...
    static let backGroundColor = UIColor.rgb(red: 17, green: 25, Blue: 25)
...
extension UIView{
    ...
    func anchor(top: NSLayoutYAxisAnchor? = nil,left: NSLayoutXAxisAnchor? = nil,bottom: NSLayoutYAxisAnchor? = nil,right: NSLayoutXAxisAnchor? = nil,paddingTop: CGFloat = 0,paddingLeft:CGFloat = 0,paddingBottom:CGFloat = 0,paddingRight:CGFloat = 0,width: CGFloat? = nil,height : CGFloat? = nil, greaterThanEqual :CGFloat? = 0){
        ...
        if let greaterThanEqual = greaterThanEqual{
            widthAnchor.constraint(greaterThanOrEqualToConstant: greaterThanEqual).isActive = true
